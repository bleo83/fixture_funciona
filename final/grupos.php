...
<!--INICIO SEMIFINAL -->
								...
								<div class="tab-pane " id="fase2e">
									...
									<div class="boxportfolio1"><!-- Partidos -->
										...
										<td width="2"><input style="max-width:50px" type="number" min="0" max="9" size="2" id="figl1l" name="figl1l" value="" onchange="clasificando(this)" onblur="clasificando(this)"
										onkeypress="return isNumber(event)" ></td>
										...
										<div id="visitante" align="center">
										<td  width="2"><input style="display: none;max-width:50px" type="number" min="0" max="50" size="2" id="figp1v" name="figp1v" value="" onchange="clasificando(this)" onblur="clasificando(this)"
										onkeypress="return isNumber(event)"></td>
										<td  width="2"><input style="max-width:50px" type="number" min="0" max="9" size="2" id="figl1v" name="figl1v" value="" onchange="clasificando(this)" onblur="clasificando(this)"
										onkeypress="return isNumber(event)"></td>
										<td style ="background: transparent;">
		...
		<div class="row">
			...
			<div style="margin-left: 500px; top: -10px;" >
				...
				<input type="text" readonly = "readonly" style ="background: transparent; color: yellow; alignment-adjust:center;" id="capais" name="capais"  align="center" value="">
					...
					<br><br>
			<input style="max-width:1000px" class="btn btn-success" type="submit" value="Guardar Fixture" onclick="valida_envia()">
			
			<script type="text/javascript"> 
			function valida_envia(){ 
				var elem = document.getElementById("capais").value;
					if(elem==""){ 
						alert("Campo Campeón vacio, u otro campo"); 
					return false; 
					}
				}
