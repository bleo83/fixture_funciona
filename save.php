...
<form>
<input readonly="readonly" style="background: transparent; border:transparent; color:yellow; font-size: 17px; max-width: 35px"type="text" size="10" name="redirect2" />
</form>
<font face="Arial" style="font-size: 17px">segundos<br>En caso contrario, pulsa el siguiente enlace:</font>
		
		                      
			<div >
				<br>
				<a style="margin-left: 15px" href="tupronostico.php" class="buttonblack">&nbsp; Ver tu pronóstico...</a>
...
<?php
}else{header('Location: tupronostico.php');}
?>